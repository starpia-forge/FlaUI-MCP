...
public class SnapshotTool : ToolBase
{
    ...
    public override string Description =>
        ...
        "Use verbose:true to include AutomationId and BoundingRect on each element line.";
    ...
    public override object InputSchema => new
    {
        ...
        properties = new
        {
            ...
            {
                type = "boolean",
                description = "Include AutomationId and BoundingRect inline on each element line. Default: false."
            }
        }
    };
    ...
    public override Task<McpToolResult> ExecuteAsync(JsonElement? arguments)
    {
        ...
        var verbose = GetBoolArgument(arguments, "verbose", false);
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(handle) && handle.StartsWith("m", StringComparison.OrdinalIgnoreCase))
            {
                ...
                var snapshot = _snapshotBuilder.BuildSnapshot(handle, popup, verbose);
            ...
            var snapshot2 = _snapshotBuilder.BuildSnapshot(resolution.Handle!, resolution.Window!, verbose);
